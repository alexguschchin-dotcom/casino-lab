...
const themesData = {
    history: {
        ...
        questions: [
            { value: 1, text: 'В каком году началась Вторая мировая война?', options: ['1939', '1941', '1937', '1945'], correct: 0, casinoTask: 'Сделайте 50 спинов по 20$  в Dog house' },
            { value: 2, text: 'Кто был первым президентом США?', options: ['Томас Джефферсон', 'Джордж Вашингтон', 'Авраам Линкольн', 'Бенджамин Франклин'], correct: 1, casinoTask: 'Сыграйте в блэкджек на две руки по ставке 300$ на руку' },
            { value: 3, text: 'Какое событие произошло в 1066 году в Англии?', options: ['Великая хартия вольностей', 'Битва при Гастингсе', 'Чума', 'Строительство Тауэра'], correct: 1, casinoTask: 'Купить бонус в Money train 4 за 1000$' },
            { value: 4, text: 'Назовите имя древнегреческого бога морей', options: ['Зевс', 'Аид', 'Посейдон', 'Аполлон'], correct: 2, casinoTask: 'Выбейте три бонуски в coin up lighting по ставке 15$ ' },
            { value: 5, text: 'Какая империя правила большей частью Южной Америки до прихода европейцев?', options: ['Ацтеки', 'Майя', 'Империя инков', 'Ольмеки'], correct: 2, casinoTask: 'Бонус за 1600$ в sweet bonanza или Выбейте топовую бонуску в le bandit ставка от 18$ с шансом' }
        ]
    },
    geography: {
        name: 'География',
        ...
        questions: [
            ...
            { value: 5, text: 'Какая страна имеет самое большое количество часовых поясов?', options: ['США', 'Канада', 'Россия', 'Китай'], correct: 2, casinoTask: 'купить le bunny от 1500$ или получить х200 в Miami Mayhem за 420$  ' }
        ]
    },
    cinema: {
        name: 'Кино',
        ...
        questions: [
            ...
            { value: 4, text: 'В каком фильме звучит фраза "Я оглянулся посмотреть, не оглянулась ли она"?', options: ['Москва слезам не верит', 'Ирония судьбы', 'Служебный роман', 'Карнавальная ночь'], correct: 1, casinoTask: 'Окупить бонус в dog house multihold за 600$' },
    ...
    science: {
        ...
        questions: [
            ...
            { value: 2, text: 'Какой химический элемент обозначается буквой O?', options: ['Осмий', 'Олово', 'Кислород', 'Золото'], correct: 2, casinoTask: 'Окупить бонус в retro sweet в бонуске от 400$' },
            { value: 3, text: 'Сколько планет в Солнечной системе?', options: ['7', '8', '9', '6'], correct: 1, casinoTask: 'Пробить топовую бонуску в Мумии в рандомке за 360$' },
            { value: 4, text: 'Назовите самую маленькую частицу, сохраняющую свойства элемента', options: ['Молекула', 'Протон', 'Электрон', 'Атом'], correct: 3, casinoTask: 'Покупать топовый бонус в le pharaon за 750$ пока не окупится' },
            { value: 5, text: 'Кто изобрёл радио?', options: ['Попов', 'Маркони', 'Тесла', 'Эдисон'], correct: 0, casinoTask: 'Выбить х1000 в sweet bonanza 1000 в бонуске за 400$ или поймать ретриггер в топовой бонуске в sugar rush за 400$' }
        ]
    },
    casino: {
        name: 'Казино',
        ...
        questions: [
            ...
            { value: 3, text: 'Сколько чисел в европейской рулетке?', options: ['36', '37', '38', '39'], correct: 1, casinoTask: 'Выбить бонуску в pirates pub ставка от 12$' },
            { value: 4, text: 'Как называется комбинация в покере: 2, 3, 4, 5, 6 одной масти?', options: ['Флеш', 'Стрит', 'Стрит-флеш', 'Каре'], correct: 2, casinoTask: 'Выбить больше 12 спинов и 4 иксов в топовой бонуске release the kraken 2 jn 500$' },
            { value: 5, text: 'Какой биохимический процесс в мозге усиливает желание играть в казино?', options: ['Выработка адреналина', 'Выработка дофамина', 'Выработка эндорфинов', 'Выработка серотонина'], correct: 2, casinoTask: 'Выиграйте х300 в Sweet bonanza по ставке от 500$ или сделать накид создателю ' }
        ]
    }
};
