...
const themesData = {
    ...
    geography: {
        ...
        questions: [
            ...
            { value: 5, text: 'Какая страна имеет самое большое количество часовых поясов?', options: ['США', 'Канада', 'Россия', 'Китай'], correct: 2, casinoTask: 'Сделать накид создателю или купить le bunny от 2000$' }
        ]
    },
    cinema: {
        name: 'Кино',
