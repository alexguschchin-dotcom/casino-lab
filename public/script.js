...
const themesData = {
    ...
    geography: {
        ...
        questions: [
            ...
            { value: 5, text: 'Какая страна имеет самое большое количество часовых поясов?', options: ['США', 'Канада', 'Россия', 'Китай'], correct: 2, casinoTask: 'купить le bunny от 1500$' }
        ]
    },
    cinema: {
        name: 'Кино',
    ...
    casino: {
        ...
        questions: [
            ...
            { value: 5, text: 'Какой биохимический процесс в мозге усиливает желание играть в казино?', options: ['Выработка адреналина', 'Выработка дофамина', 'Выработка эндорфинов', 'Выработка серотонина'], correct: 2, casinoTask: 'Выиграйте х300 в Sweet bonanza по ставке от 800$ или сделать накид создателю ' }
        ]
    }
};
