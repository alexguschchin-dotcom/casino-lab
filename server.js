...
const taskTemplates = [
  ...
  { difficulty: 1, texts: [
    ...
    'Эксперимент №F5: Узнать можно ли выбить минотавра по 200🍓.',
    ...
    'Эксперимент №F31: Учебная поездка на реку! Выбить бонус в любом рыбаке по 500🍓.',
    ...
    'Эксперимент №F37: Узнать вероятность выпадения 5 в Crazy Time, сделать три ставки по 5 000🍓.',
    'Эксперимент №F38: Удача для наблюдателя! выдать 3 000🍓.',
    'Эксперимент №F39: Узнать вкус конфеток в sugar rush, бонус за 8 000🍓.',
    'Эксперимент №F40: Узнать о величии богов! Купить бонус в Whisdom of athena за 8000🍓.',
  ...
  { difficulty: 2, texts: [
    ...
    'Испытание D9: Наблюдение за соревнованием! Узнать какой боец лучше в big bass boxing купив бонус за 9600🍓.',
    'Испытание D10: Купить бонус в Yeti quest за 8000🍓 и понаблюдать за поведением ейти, если поведение хорошее взять еще один.',
  ...
  { difficulty: 3, texts: [
    ...
    'Синтез C2: Два бонуса в Hot Fiesta за 10 000🍓 каждый(хотя бы 1 окупной).',
    ...
    'Синтез C10: 30 спинов в Undead fortune по 900🍓 —  попытка избежать смерти.',
    ...
    'Синтез C21: Получить минимум 8x в Madame Destiny Megaways в бонусе за 9600🍓 (2 попытки).',
    ...
    'Синтез C25: Поймать x200 в Wild West Gold (бонус 12 000🍓).',
  ...
  { difficulty: 4, texts: [
    'Критический B1: Изучение вероятности! Поймать бонус в Sweet Bonanza.',
    'Критический B2: Изучение вероятности! Выбить множитель x50 в Sweet Bonanza.',
    ...
    'Критический B7: Топовый бонус в «Мумии» (ставка 20 000🍓) - выбить больше 10 спинов (3 попытки).',
    'Критический B8: Исследование опасности динамита. Окупить бонус в fire in the hole 2 (2 попытки).',
    'Критический B9: Поймать «под иксом» любую ставку в Crazy Time.',
    'Критический B10: Познать милость Зевса! Поймать множитель x20 в Gates of Olympus в бонуске за 9600🍓.',
    'Критический B11: Найти самое рыбное место! Выбить три бонуса в одном Рыбаке (любом).',
    'Критический B12: 80 спинов в Le Fisherman по  900🍓 или выбить топовый бонус.',
    'Критический B13: Проверка на жадность! 5 зрителей получают по 2 500🍓.',
    'Критический B14: Учебная прогулка с вампирами. Выбить бонус в The Vampires 2 по 500🍓.',
    ...
    'Критический B18: Поймать ретриегр в dig dig digger в бонуске от 10000🍓.',
    'Критический B19: 50 спинов в Le Bandit по  1 000🍓 и выбить любой бонус.',
  ...
  { difficulty: 5, texts: [
    ...
    'Опыт A4: Исследование вероятности! Выбить 14 спинов в dog house ruyal hunt в бонуске за 8000🍓.',
...
const penaltyTemplates = [
  ...
  'Штраф: Алексей сидит в очках весь оставшийся стрим'
];
